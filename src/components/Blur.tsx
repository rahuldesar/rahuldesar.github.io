...
const Blur = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-background ">
      <div
        ref={blobRef}
        className="translate-middle absolute aspect-square h-0 opacity-40 animate-custom-rotate rounded-full bg-gradient-to-r  from-green-400  to-red-500 ease-in-out "
        ></div>
      <div id="blur" className="absolute z-10 h-full w-full backdrop-blur-[100px]"></div>
    </div>
  );
};
