...
const Blur = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-background ">
      ...
      <div
        className="top-50 absolute left-3/4 z-20 
            h-60 animate-custom-rotate rounded-[67%] rounded-full rounded-b-[0%] rounded-r-[100%] rounded-t-[33%] rounded-bl-[0%] rounded-br-[74%]  rounded-tl-[100%] rounded-tr-[26%] bg-gradient-to-r  from-green-400 to-red-500 opacity-30 ease-in-out"
      ></div>
    </div>
  );
};
